...
export const OfficeInfo: React.FC = () => {
  ...
  return (
    <section className="w-full max-w-[1372px] mt-12 max-md:mt-10 px-4 mx-auto mb-12">
      <div className="flex w-full gap-7 justify-between flex-wrap">
        ...
        <div className="w-full lg:w-[40%] min-w-[300px] max-md:mt-6 rounded-[20px] max-md:max-w-full">
          <div className="bg-white border overflow-hidden text-base text-black font-medium pl-6 md:pl-[30px] pr-4 py-[30px] rounded-[20px] border-[rgba(0,0,0,0.1)] border-solid">
            <h3 className="text-[rgba(37,111,255,1)] text-xl font-semibold">
              Visit Our Office
            </h3>
            <div className="border min-h-px max-w-full w-[100%] mt-5 border-[#F5F5F5] border-solid" />
          ...
          <div className="bg-white border overflow-hidden text-sm text-[rgba(95,95,95,1)] font-semibold mt-[34px] pl-6 md:pl-[30px] pr-4 py-[30px] rounded-[20px] border-[rgba(0,0,0,0.1)] border-solid">
            <h3 className="text-[rgba(37,111,255,1)] text-xl">
              Get in Touch Directly
            </h3>
            <div className="border min-h-px max-w-full w-[100%] mt-2.5 border-[#F5F5F5] border-solid" />
